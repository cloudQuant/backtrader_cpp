...
TEST(OriginalTests, KAMA_CalculationLogic) {
    ...
    auto close_line = std::make_shared<backtrader::LineRoot>(prices.size(), "kama_calc");
...
TEST(OriginalTests, KAMA_ChoppyMarket) {
    ...
    auto choppy_line = std::make_shared<backtrader::LineRoot>(choppy_prices.size(), "choppy");
