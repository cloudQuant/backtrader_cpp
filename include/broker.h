...
public:
    ...
    virtual std::map<std::shared_ptr<DataSeries>, std::shared_ptr<Position>> getpositions() const = 0;
...
public:
    ...
    std::map<std::shared_ptr<DataSeries>, std::shared_ptr<Position>> getpositions() const override;
