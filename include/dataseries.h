...
public:
    // Standard line indices (matching Python's constants)
    static constexpr int Close = 3;
    static constexpr int Low = 2;
    static constexpr int High = 1;
    static constexpr int Open = 0;
    static constexpr int Volume = 4;
    static constexpr int OpenInterest = 5;
    static constexpr int DateTime = 6;
