...
std::optional<std::span<const double>> LineSeries::getDataSpan(const std::string& line_name, int periods) const {
    // This would require LineBuffer to expose its internal array
